    ...
    <form @submit.prevent="sendForm">
      <div id="writePage">
        <div id="writePageTitle">
          <div id="writePageHeader"><h1>액터스 구인 글쓰기</h1></div>
...
export default {
  data() {
    return {
      ...
      company:"",
      company_desc:"",
      deadline:"2021-07-05T21:33:00+09:00",
      job_position:"",
  ...
  methods:{
    ...
    returnList(){ //리스트 화면으로 이동 함수
      this.$router.push({path:'./HireActor',query:this.body});
    },
    sendForm() {
      ...
      formData.append("thumbs", 0);
          ...
          axios({
            method: "POST",
            url: 'http://127.0.0.1:8000/film/hirepostactor/',
            data: formData,
